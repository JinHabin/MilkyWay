...
<div class="sub">
  ...
  <section>
          ...
          <div class="op">
            ...
            <li><div><button id="btna" class="selButton" type="button" onclick="location.href='notice_read.jsp'" >전체</button></div></li>
...
try {
	...
	if (t.equals("e")) {
		sql="select * from noticedata where type='행사' order by id desc limit "+startNum+",5";
	}
	else if (t.equals("h")) {
		sql="select * from noticedata where type='의료' order by id desc limit "+startNum+",5";
	}
	else if (t.equals("w")) {
		sql="select * from noticedata where type='복지' order by id desc limit "+startNum+",5";
	}
	else if (t.equals("a")){
		sql="select * from noticedata order by id desc limit "+startNum+",5";
	}
	else {
		sql="select * from noticedata order by id desc limit "+startNum+",5";
