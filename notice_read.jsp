...
<div class="goOtherMenu1">
    <div id="subborder"><h2><center><b>행사정보</b></center></h2>
    </div>
...
<div class="sub">
    <nav>
      <ul class="ul1">
          <li><button class="btn" type="button">행사정보</button></li>
  ...
  <section>
          ...
          <div class="op">
         	<ul class="ul2">
            <li><div><button id="sel11" class="selOther" type="button">말머리 선택</button></div></li>
    		<li><div><button class="selButton" type="button" onclick="location.href='http://naver.com'" >행사</button></div></li>
            <li><div><button class="selButton" type="button">복지</button></div></li>
            <li><div><button class="selButton" type="button">의료</button></div></li>
			</ul>
			</div>
...
try {
	...
	sql="select * from noticedata order by id desc limit "+startNum+",5"; // order by ref desc, id asc
...
while (rs.next()) {
	...
	<tr height="30">
	<td class="number" align="center"><%=rownum %></td>
	<td class="type1" align="center"><%=rs.getString("type") %></td>
	<td class="title" align="center"><a href="4-read.jsp?id=<%=id%>"><%=rs.getString("title") %></a></td>
	...
	%>
     ...
     <div class="paging">
          ...
          for (int i=1; i<=pn+1; i++) {
        	  %>
        	  <li class="p1"><button class="btn22" type="button" onclick="location.href='page4_notice_read.jsp?pageNum=<%=i%>'"><%=i %></button></li>
        	  <%
          }
          %>
          <li><button class="write" type="button" onclick="location.href='notice_write.jsp'">
              글작성</button></li>
