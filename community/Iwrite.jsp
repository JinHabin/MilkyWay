...
<div class="container">
    <div class="row">
        <form method="post" action="writeAction.jsp">
            ...
            <thead>
                <tr>
                    <th colspan="2" style="background-color: #3e8996; text-align: center;">게시판 글 작성 양식</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <input type="submit" class="btn btn-primary pull-right" style="margin:3px; background-color:#b1cfd5" value="글 쓰기">
        </form>
    </div>
</div>
